...
class DiscordConsole(discord.Client):
    ...
    async def on_ready(self):
        ...
        print("The command will take few seconds to work.\nJoin https://discord.gg/9BGTvnWn9u for more support\n")
...
@app_commands.choices(
    ...
    repeat1=[app_commands.Choice(name=opt, value=i) for i,opt in enumerate(farmlist)],
    repeat2=[app_commands.Choice(name=opt, value=i) for i,opt in enumerate(farmlist2)])
...
@bot.tree.command(name="mangosettings", description = "Your current farm settings")
